...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        $sm->get('viewhelpermanager')->setFactory('PublicidadeView', function ($sm) use ($e) {
            return new PublicidadeView($e, $sm);
        });
    ...
    public function getViewHelperConfig()
    {
        return array(
            ...
            'invokables' => array(
                ...
                'publicidadeView' => 'Core\View\PublicidadeView',
            ),
        );
