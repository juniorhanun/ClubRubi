 ...
 * @package Core\View
 */
class PublicidadeView  extends AbstractHelper implements ServiceManagerAwareInterface
{
    /*
    ...
    public function __invoke() {
        ...
        $publicidade = $this->getEntityManager()->getRepository('Admin\Entity\Publicidade')->findBy(array('status' => 1));
