...
abstract class AbstractController extends AbstractActionController
{
    ...
    {
        if(empty($this->campoPesquisa)):
            // Resebe os dados da Entidade passada
            $list = $this->getEm()->getRepository($this->entity)->findBy(array(),array($this->campoOrder => $this->order));
        else:
            // Resebe os dados da Entidade passada
    ...
    public function inserirAction()
    {
        ...
        if ($request->isPost()){
            ...
            if ($form->isValid()){
                ...
                // Verifica se foi passado algum arquivo de upload
